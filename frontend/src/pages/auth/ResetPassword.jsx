      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-blue overflow-hidden border border-teal-100">
        ...
        <div className="p-8">
          <div className="text-center mb-7">
            ...
            <h1 className="text-2xl font-extrabold text-slate-900" style={{ fontFamily:'Space Grotesk,sans-serif' }}>Set New Password</h1>
          </div>
          <form onSubmit={onSubmit} className="space-y-5">
            {useOtp && (
              <div>
                <label className="block text-sm font-semibold text-slate-900 mb-1.5">OTP</label>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button type="button" onClick={() => setShow(!show)}
                  className="absolute right-3.5 top-1/2 -translate-y-1/2 text-gray-400 hover:text-teal-600">
