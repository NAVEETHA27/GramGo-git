...
export default function VerifyEmail() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background:'#F6F8FB' }}>
      <div className="bg-white rounded-3xl shadow-blue p-12 text-center max-w-sm border border-teal-100">
        {status === 'loading' && (<><div className="text-5xl mb-4 animate-spin">⏳</div><h2 className="text-xl font-bold text-slate-900">Verifying…</h2></>)}
        {status === 'success' && (<>
